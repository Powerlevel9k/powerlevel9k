...
* **Python Segments:**
    ...
    * [`pyver`](segments/pyver/README.md) - Your current Python Version, by default hidden if your current Python Version is the same as the globally installed version.
