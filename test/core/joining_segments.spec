...
function testRightNormalSegmentsShouldNotBeJoined() {
  ...
  assertEquals "%F{015}%K{015}%F{000} \${:-\"world1\"} %F{000}%K{015}%F{000} \${:-\"world2\"} %F{000}%K{015}%F{000} \${:-\"world4\"} %F{000}%K{015}%F{000} \${:-\"world6\"} %E%f%k%b" "$(__p9k_build_right_prompt)"
}
...
function testRightJoinedSegments() {
  ...
  assertEquals "%F{015}%K{015}%F{000} \${:-\"world1\"} %K{015}%F{000}\${:-\"world2\"} %E%f%k%b" "$(__p9k_build_right_prompt)"
}
...
function testRightTransitiveJoinedSegments() {
  ...
  assertEquals "%F{015}%K{015}%F{000} \${:-\"world1\"} %K{015}%F{000}\${:-\"world2\"} %K{015}%F{000}\${:-\"world3\"} %E%f%k%b" "$(__p9k_build_right_prompt)"
}
...
function testRightTransitiveJoiningWithConditionalJoinedSegment() {
  ...
  assertEquals "%F{015}%K{015}%F{000} \${:-\"world1\"} %K{015}%F{000}\${:-\"world2\"} %K{015}%F{000}\${:-\"world4\"} %E%f%k%b" "$(__p9k_build_right_prompt)"
}
...
function testRightPromotingSegmentWithConditionalPredecessor() {
  ...
  assertEquals "%F{015}%K{015}%F{000} \${:-\"world1\"} %F{000}%K{015}%F{000} \${:-\"world3\"} %E%f%k%b" "$(__p9k_build_right_prompt)"
}
...
function testRightPromotingSegmentWithJoinedConditionalPredecessor() {
  ...
  assertEquals "%F{015}%K{015}%F{000} \${:-\"world1\"} %F{000}%K{015}%F{000} \${:-\"world4\"} %E%f%k%b" "$(__p9k_build_right_prompt)"
}
...
function testRightPromotingSegmentWithDeepJoinedConditionalPredecessor() {
  ...
  assertEquals "%F{015}%K{015}%F{000} \${:-\"world1\"} %F{000}%K{015}%F{000} \${:-\"world4\"} %K{015}%F{000}\${:-\"world6\"} %E%f%k%b" "$(__p9k_build_right_prompt)"
}
...
function testRightJoiningBuiltinSegmentWorks() {
  ...
  assertEquals "%F{013}%K{013}%F{255} \${:-\"1.2.3\"} %F{255}PHP%f %K{013}%F{255}\${:-\"1.2.3\"} %F{255}PHP%f %E%f%k%b" "$(__p9k_build_right_prompt)"
