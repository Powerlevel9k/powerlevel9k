...
function testDirSegmentAbsolutePerformance() {
  ...
  if [[ "${OS}" == 'Linux' ]]; then
    samplePerformanceSilent "Dir Absolute (Linux)" build_left_prompt
  elif [[ "${OS}" == 'OSX' ]]; then
    samplePerformanceSilent "Dir Absolute (OSX)" build_left_prompt
  fi

  cd -
}

function testDirSegmentTruncatePerformance() {
  local -a POWERLEVEL9K_LEFT_PROMPT_ELEMENTS
  POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir)
  ...
  samplePerformanceSilent "Dir Truncate" build_left_prompt

  cd -
  rm -fr /tmp/powerlevel9k-test
}

function testDirSegmentTruncateHomePerformance() {
  local -a POWERLEVEL9K_LEFT_PROMPT_ELEMENTS
  POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir)
  ...
  samplePerformanceSilent "Dir Truncate Home" build_left_prompt

  rmdir $FOLDER
  cd ${CURRENT_DIR}
}

function testDirSegmentTruncateMiddlePerformance() {
  local -a POWERLEVEL9K_LEFT_PROMPT_ELEMENTS
  POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir)
  local POWERLEVEL9K_SHORTEN_DIR_LENGTH=2
  ...
  samplePerformanceSilent "Dir Truncate Middle" build_left_prompt

  cd -
  rm -fr /tmp/powerlevel9k-test
}

function testDirSegmentTruncateRightPerformance() {
  local -a POWERLEVEL9K_LEFT_PROMPT_ELEMENTS
  POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir)
  local POWERLEVEL9K_SHORTEN_DIR_LENGTH=2
  ...
  samplePerformanceSilent "Dir Truncate Right" build_left_prompt

  cd -
  rm -fr /tmp/powerlevel9k-test
}

function testDirSegmentTruncateLastPerformance() {
  local -a POWERLEVEL9K_LEFT_PROMPT_ELEMENTS
  POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir)
  local POWERLEVEL9K_SHORTEN_DIR_LENGTH=2
  ...
  samplePerformanceSilent "Dir Truncate Last" build_left_prompt

  cd -
  rm -fr /tmp/powerlevel9k-test
}

function testDirSegmentTruncateFirstLastPerformance() {
  local -a POWERLEVEL9K_LEFT_PROMPT_ELEMENTS
  POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir)
  local POWERLEVEL9K_SHORTEN_DIR_LENGTH=2
  ...
  samplePerformanceSilent "Dir Truncate First Last" build_left_prompt

  cd -
  rm -fr /tmp/powerlevel9k-test
}

function testDirSegmentTruncateAbsolutePerformance() {
  local -a POWERLEVEL9K_LEFT_PROMPT_ELEMENTS
  POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(dir)
  local POWERLEVEL9K_SHORTEN_DIR_LENGTH=2
