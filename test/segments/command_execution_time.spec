...
function testCommandExecutionTimeThresholdCouldBeChanged() {
  ...
  assertEquals "%K{red} %k%F{yellow1}Dur%f %F{yellow1}2.03 %k%F{red}%f " "$(build_left_prompt)"
...
function testCommandExecutionTimeThresholdCouldBeSetToZero() {
  ...
  assertEquals "%K{red} %k%F{yellow1}Dur%f %F{yellow1}0.03 %k%F{red}%f " "$(build_left_prompt)"
...
function testCommandExecutionTimePrecisionCouldBeChanged() {
  ...
  assertEquals "%K{red} %k%F{yellow1}Dur%f %F{yellow1}0.0001 %k%F{red}%f " "$(build_left_prompt)"
...
function testCommandExecutionTimePrecisionCouldBeSetToZero() {
  ...
  assertEquals "%K{red} %k%F{yellow1}Dur%f %F{yellow1}23 %k%F{red}%f " "$(build_left_prompt)"
...
function testCommandExecutionTimeIsFormattedHumandReadbleForMinuteLongCommand() {
  ...
  assertEquals "%K{red} %k%F{yellow1}Dur%f %F{yellow1}03:00 %k%F{red}%f " "$(build_left_prompt)"
...
function testCommandExecutionTimeIsFormattedHumandReadbleForHourLongCommand() {
  ...
  assertEquals "%K{red} %k%F{yellow1}Dur%f %F{yellow1}02:00:00 %k%F{red}%f " "$(build_left_prompt)"
